...
export default function Level14({ onUnlock }: Level14Props) {
  return (
    <LevelTemplate
      levelNumber={14}
      ...
      riddleContent={
        <>
          ...
          <ContentText text="Here is the enigma description for Level 14. Refer to Level 0 for example structure." />
      ...
      hints={[
        <Hint number={1}>
          ...
          <ContentText text="Here is hint 1 for level 14." />
        </Hint>,
        <Hint number={2}>
          <ComponentLabel name="ContentText inside Hint" />
          <ContentText text="Here is hint 2 for level 14." />
        </Hint>,
        <Hint number={3}>
